...
if __name__ == "__main__":
    measures_list = ["Temporal Topology:", "Temporal Precision:", "Temporal Recall:", "Temporal F-Score:"]
    nb_measures = len(measures_list)
    path_input = './results_temporal'
    ...
    for dataset in datasets_list:
        ...
        print(results_table)
        results_table.to_csv(r'./summary_ts/'+str(dataset)+'.txt', sep='&')
